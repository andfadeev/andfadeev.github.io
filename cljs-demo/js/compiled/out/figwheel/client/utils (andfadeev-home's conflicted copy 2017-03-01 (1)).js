...
return (new CustomEvent(event_name,(function (){var obj119274 = {"detail":data};
return obj119274;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__25113__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__25113__auto__)){
var and__25113__auto____$1 = (window["CustomEvent"]);
...
var args119279 = [];
var len__26200__auto___119285 = arguments.length;
var i__26201__auto___119286 = (0);
while(true){
if((i__26201__auto___119286 < len__26200__auto___119285)){
args119279.push((arguments[i__26201__auto___119286]));

var G__119287 = (i__26201__auto___119286 + (1));
i__26201__auto___119286 = G__119287;
continue;
} else {
}
break;
...
var G__119281 = args119279.length;
switch (G__119281) {
case 1:
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args119279.length)].join('')));
...
var f = (function (){var pred__119282 = cljs.core._EQ_;
var expr__119283 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__119282.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__119283))){
return ((function (pred__119282,expr__119283){
return (function (p1__119275_SHARP_){
return console.warn(p1__119275_SHARP_);
});
;})(pred__119282,expr__119283))
} else {
if(cljs.core.truth_(pred__119282.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__119283))){
return ((function (pred__119282,expr__119283){
return (function (p1__119276_SHARP_){
return console.debug(p1__119276_SHARP_);
});
;})(pred__119282,expr__119283))
} else {
if(cljs.core.truth_(pred__119282.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__119283))){
return ((function (pred__119282,expr__119283){
return (function (p1__119277_SHARP_){
return console.error(p1__119277_SHARP_);
});
;})(pred__119282,expr__119283))
} else {
return ((function (pred__119282,expr__119283){
return (function (p1__119278_SHARP_){
return console.log(p1__119278_SHARP_);
});
;})(pred__119282,expr__119283))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__119289){
var map__119292 = p__119289;
var map__119292__$1 = ((((!((map__119292 == null)))?((((map__119292.cljs$lang$protocol_mask$partition0$ & (64))) || (map__119292.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__119292):map__119292);
var opts = map__119292__$1;
var eval_fn = cljs.core.get.call(null,map__119292__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__119294_SHARP_);
});})(new_def))
);
...
return (function (p__119295){
var vec__119296 = p__119295;
var ky = cljs.core.nth.call(null,vec__119296,(0),null);
var v = cljs.core.nth.call(null,vec__119296,(1),null);
...
var args119299 = [];
var len__26200__auto___119302 = arguments.length;
var i__26201__auto___119303 = (0);
while(true){
if((i__26201__auto___119303 < len__26200__auto___119302)){
args119299.push((arguments[i__26201__auto___119303]));

var G__119304 = (i__26201__auto___119303 + (1));
i__26201__auto___119303 = G__119304;
continue;
} else {
}
break;
...
var G__119301 = args119299.length;
switch (G__119301) {
case 2:
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args119299.length)].join('')));
...
if(cljs.core.truth_((function (){var and__25113__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1488400173513