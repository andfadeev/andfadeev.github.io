...
return (new CustomEvent(event_name,(function (){var obj105773 = {"detail":data};
return obj105773;
})()));
} else {
...
var args105778 = [];
var len__26200__auto___105784 = arguments.length;
var i__26201__auto___105785 = (0);
while(true){
if((i__26201__auto___105785 < len__26200__auto___105784)){
args105778.push((arguments[i__26201__auto___105785]));

var G__105786 = (i__26201__auto___105785 + (1));
i__26201__auto___105785 = G__105786;
continue;
} else {
}
break;
...
var G__105780 = args105778.length;
switch (G__105780) {
case 1:
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args105778.length)].join('')));
...
var f = (function (){var pred__105781 = cljs.core._EQ_;
var expr__105782 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__105781.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__105782))){
return ((function (pred__105781,expr__105782){
return (function (p1__105774_SHARP_){
return console.warn(p1__105774_SHARP_);
});
;})(pred__105781,expr__105782))
} else {
if(cljs.core.truth_(pred__105781.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__105782))){
return ((function (pred__105781,expr__105782){
return (function (p1__105775_SHARP_){
return console.debug(p1__105775_SHARP_);
});
;})(pred__105781,expr__105782))
} else {
if(cljs.core.truth_(pred__105781.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__105782))){
return ((function (pred__105781,expr__105782){
return (function (p1__105776_SHARP_){
return console.error(p1__105776_SHARP_);
});
;})(pred__105781,expr__105782))
} else {
return ((function (pred__105781,expr__105782){
return (function (p1__105777_SHARP_){
return console.log(p1__105777_SHARP_);
});
;})(pred__105781,expr__105782))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__105788){
var map__105791 = p__105788;
var map__105791__$1 = ((((!((map__105791 == null)))?((((map__105791.cljs$lang$protocol_mask$partition0$ & (64))) || (map__105791.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__105791):map__105791);
var opts = map__105791__$1;
var eval_fn = cljs.core.get.call(null,map__105791__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__105793_SHARP_){
return new_def.callback(p1__105793_SHARP_);
});})(new_def))
);
...
return (function (p__105794){
var vec__105795 = p__105794;
var ky = cljs.core.nth.call(null,vec__105795,(0),null);
var v = cljs.core.nth.call(null,vec__105795,(1),null);
...
var args105798 = [];
var len__26200__auto___105801 = arguments.length;
var i__26201__auto___105802 = (0);
while(true){
if((i__26201__auto___105802 < len__26200__auto___105801)){
args105798.push((arguments[i__26201__auto___105802]));

var G__105803 = (i__26201__auto___105802 + (1));
i__26201__auto___105802 = G__105803;
continue;
} else {
}
break;
...
//# sourceMappingURL=utils.js.map?rel=1488399917999