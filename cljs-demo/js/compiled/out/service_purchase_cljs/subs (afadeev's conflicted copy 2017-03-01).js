...
re_frame.core.reg_sub.call(null,new cljs.core.Keyword(null,"agreements","agreements",496150773),(function (p1__79913_SHARP_){
return new cljs.core.Keyword(null,"agreements","agreements",496150773).cljs$core$IFn$_invoke$arity$1(p1__79913_SHARP_);
}));
...
return cljs.core.some.call(null,(function (p1__79914_SHARP_){
if(cljs.core._EQ_.call(null,service_type_id,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__79914_SHARP_))){
return p1__79914_SHARP_;
} else {
return null;
}
}),dictionary);
...
re_frame.core.reg_sub.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),(function (p1__79915_SHARP_){
return new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"service-form","service-form",323909684).cljs$core$IFn$_invoke$arity$1(p1__79915_SHARP_));
}));
re_frame.core.reg_sub.call(null,new cljs.core.Keyword(null,"service-form","service-form",323909684),(function (p1__79916_SHARP_){
return new cljs.core.Keyword(null,"service-form","service-form",323909684).cljs$core$IFn$_invoke$arity$1(p1__79916_SHARP_);
}));
...
re_frame.core.reg_sub.call(null,new cljs.core.Keyword(null,"panel-params","panel-params",1099672237),(function (p1__79917_SHARP_){
return new cljs.core.Keyword(null,"panel-params","panel-params",1099672237).cljs$core$IFn$_invoke$arity$1(p1__79917_SHARP_);
}));
...
//# sourceMappingURL=subs.js.map?rel=1488396829767