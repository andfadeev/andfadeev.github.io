...
var G__91397 = o;
(G__91397[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__91398__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__91398 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__91399__i = 0, G__91399__a = new Array(arguments.length -  0);
while (G__91399__i < G__91399__a.length) {G__91399__a[G__91399__i] = arguments[G__91399__i + 0]; ++G__91399__i;}
  args = new cljs.core.IndexedSeq(G__91399__a,0);
} 
return G__91398__delegate.call(this,args);};
G__91398.cljs$lang$maxFixedArity = 0;
G__91398.cljs$lang$applyTo = (function (arglist__91400){
var args = cljs.core.seq(arglist__91400);
return G__91398__delegate(args);
});
G__91398.cljs$core$IFn$_invoke$arity$variadic = G__91398__delegate;
return G__91398;
})()
;
} else {
...
var G__91406 = jsprops;
(G__91406["defaultValue"] = value);

(G__91406["onChange"] = ((function (G__91406,v,value,on_change){
return (function (p1__91403_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__91403_SHARP_);
});})(G__91406,v,value,on_change))
);

(G__91406["ref"] = ((function (G__91406,v,value,on_change){
return (function (p1__91404_SHARP_){
return (this$["cljsInputElement"] = p1__91404_SHARP_);
});})(G__91406,v,value,on_change))
);
...
var vec__91413 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__91413,(0),null);
var id = cljs.core.nth.call(null,vec__91413,(1),null);
var class$ = cljs.core.nth.call(null,vec__91413,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___91418 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___91418 == null)){
} else {
var key_91419 = temp__4661__auto___91418;
(jsprops["key"] = key_91419);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__91421 = (new reagent.impl.template.NativeWrapper());
(G__91421["name"] = c);
...
var len__26200__auto___91427 = arguments.length;
var i__26201__auto___91428 = (0);
while(true){
if((i__26201__auto___91428 < len__26200__auto___91427)){
args__26207__auto__.push((arguments[i__26201__auto___91428]));

var G__91429 = (i__26201__auto___91428 + (1));
i__26201__auto___91428 = G__91429;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq91425){
var G__91426 = cljs.core.first.call(null,seq91425);
var seq91425__$1 = cljs.core.next.call(null,seq91425);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__91426,seq91425__$1);
});
...
break;
default:
var G__91433 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__91433;
continue;
...
var n__26040__auto___91436 = a.length;
var i_91437 = (0);
while(true){
if((i_91437 < n__26040__auto___91436)){
(a[i_91437] = reagent.impl.template.as_element.call(null,(a[i_91437])));

var G__91438 = (i_91437 + (1));
i_91437 = G__91438;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__26040__auto___91439 = a.length;
var i_91440 = (0);
while(true){
if((i_91440 < n__26040__auto___91439)){
var val_91441 = (a[i_91440]);
if((cljs.core.vector_QMARK_.call(null,val_91441)) && ((reagent.impl.template.key_from_vec.call(null,val_91441) == null))){
(o["no-key"] = true);
} else {
}

(a[i_91440] = reagent.impl.template.as_element.call(null,val_91441));

var G__91442 = (i_91440 + (1));
i_91440 = G__91442;
continue;
} else {
}
...
var ctx = ({});
var vec__91446 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__91446,(0),null);
var derefed = cljs.core.nth.call(null,vec__91446,(1),null);
...
var G__91450 = (cljs.core.count.call(null,argv) - first_child);
switch (G__91450) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__91450){
...
//# sourceMappingURL=template.js.map?rel=1488399752326