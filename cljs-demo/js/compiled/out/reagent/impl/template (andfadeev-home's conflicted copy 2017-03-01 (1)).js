...
var G__97210 = o;
(G__97210[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__97211__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__97211 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__97212__i = 0, G__97212__a = new Array(arguments.length -  0);
while (G__97212__i < G__97212__a.length) {G__97212__a[G__97212__i] = arguments[G__97212__i + 0]; ++G__97212__i;}
  args = new cljs.core.IndexedSeq(G__97212__a,0);
} 
return G__97211__delegate.call(this,args);};
G__97211.cljs$lang$maxFixedArity = 0;
G__97211.cljs$lang$applyTo = (function (arglist__97213){
var args = cljs.core.seq(arglist__97213);
return G__97211__delegate(args);
});
G__97211.cljs$core$IFn$_invoke$arity$variadic = G__97211__delegate;
return G__97211;
})()
;
} else {
...
var G__97219 = jsprops;
(G__97219["defaultValue"] = value);

(G__97219["onChange"] = ((function (G__97219,v,value,on_change){
return (function (p1__97216_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__97216_SHARP_);
});})(G__97219,v,value,on_change))
);

(G__97219["ref"] = ((function (G__97219,v,value,on_change){
return (function (p1__97217_SHARP_){
return (this$["cljsInputElement"] = p1__97217_SHARP_);
});})(G__97219,v,value,on_change))
);
...
var vec__97226 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__97226,(0),null);
var id = cljs.core.nth.call(null,vec__97226,(1),null);
var class$ = cljs.core.nth.call(null,vec__97226,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___97231 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___97231 == null)){
} else {
var key_97232 = temp__4661__auto___97231;
(jsprops["key"] = key_97232);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__97234 = (new reagent.impl.template.NativeWrapper());
(G__97234["name"] = c);
...
var len__26200__auto___97240 = arguments.length;
var i__26201__auto___97241 = (0);
while(true){
if((i__26201__auto___97241 < len__26200__auto___97240)){
args__26207__auto__.push((arguments[i__26201__auto___97241]));

var G__97242 = (i__26201__auto___97241 + (1));
i__26201__auto___97241 = G__97242;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq97238){
var G__97239 = cljs.core.first.call(null,seq97238);
var seq97238__$1 = cljs.core.next.call(null,seq97238);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__97239,seq97238__$1);
});
...
break;
default:
var G__97246 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__97246;
continue;
...
var n__26040__auto___97249 = a.length;
var i_97250 = (0);
while(true){
if((i_97250 < n__26040__auto___97249)){
(a[i_97250] = reagent.impl.template.as_element.call(null,(a[i_97250])));

var G__97251 = (i_97250 + (1));
i_97250 = G__97251;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__26040__auto___97252 = a.length;
var i_97253 = (0);
while(true){
if((i_97253 < n__26040__auto___97252)){
var val_97254 = (a[i_97253]);
if((cljs.core.vector_QMARK_.call(null,val_97254)) && ((reagent.impl.template.key_from_vec.call(null,val_97254) == null))){
(o["no-key"] = true);
} else {
}

(a[i_97253] = reagent.impl.template.as_element.call(null,val_97254));

var G__97255 = (i_97253 + (1));
i_97253 = G__97255;
continue;
} else {
}
...
var ctx = ({});
var vec__97259 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__97259,(0),null);
var derefed = cljs.core.nth.call(null,vec__97259,(1),null);
...
var G__97263 = (cljs.core.count.call(null,argv) - first_child);
switch (G__97263) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__97263){
...
//# sourceMappingURL=template.js.map?rel=1488399899770