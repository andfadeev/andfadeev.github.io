...
var or__25125__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__25125__auto__)){
return or__25125__auto__;
} else {
var or__25125__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__25125__auto____$1)){
return or__25125__auto____$1;
} else {
var or__25125__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__25125__auto____$2)){
return or__25125__auto____$2;
} else {
var or__25125__auto____$3 = (w["msRequestAnimationFrame"]);
if(cljs.core.truth_(or__25125__auto____$3)){
...
var c_113672 = (a[i]);
if((c_113672["cljsIsDirty"]) === true){
(c_113672["forceUpdate"])();
} else {
}
...
var n__26040__auto__ = fs.length;
var i = (0);
while(true){
if((i < n__26040__auto__)){
(fs[i]).call(null);
...
var temp__4661__auto___113675 = (this$["componentQueue"]);
if((temp__4661__auto___113675 == null)){
} else {
var cs_113676 = temp__4661__auto___113675;
(this$["componentQueue"] = null);

reagent.impl.batching.run_queue.call(null,cs_113676);
}
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__25731__auto__,writer__25732__auto__,opt__25733__auto__){
return cljs.core._write.call(null,writer__25732__auto__,"reagent.impl.batching/RenderQueue");
});
...
//# sourceMappingURL=batching.js.map?rel=1488400159194