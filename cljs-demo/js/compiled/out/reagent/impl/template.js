...
var G__26837 = o;
(G__26837[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__26846 = jsprops;
(G__26846["defaultValue"] = value);

(G__26846["onChange"] = ((function (G__26846,v,value,on_change){
return (function (p1__26843_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__26843_SHARP_);
});})(G__26846,v,value,on_change))
);

(G__26846["ref"] = ((function (G__26846,v,value,on_change){
return (function (p1__26844_SHARP_){
return (this$["cljsInputElement"] = p1__26844_SHARP_);
});})(G__26846,v,value,on_change))
);
...
var vec__26853 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__26853,(0),null);
var id = cljs.core.nth.call(null,vec__26853,(1),null);
var class$ = cljs.core.nth.call(null,vec__26853,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___26858 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___26858 == null)){
} else {
var key_26859 = temp__4661__auto___26858;
...
var G__26861 = (new reagent.impl.template.NativeWrapper());
(G__26861["name"] = c);
...
var len__26200__auto___26867 = arguments.length;
var i__26201__auto___26868 = (0);
while(true){
if((i__26201__auto___26868 < len__26200__auto___26867)){
args__26207__auto__.push((arguments[i__26201__auto___26868]));

var G__26869 = (i__26201__auto___26868 + (1));
i__26201__auto___26868 = G__26869;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq26865){
var G__26866 = cljs.core.first.call(null,seq26865);
var seq26865__$1 = cljs.core.next.call(null,seq26865);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__26866,seq26865__$1);
});
...
break;
default:
var G__26873 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__26873;
continue;
...
var n__26040__auto___26876 = a.length;
var i_26877 = (0);
while(true){
if((i_26877 < n__26040__auto___26876)){
(a[i_26877] = reagent.impl.template.as_element.call(null,(a[i_26877])));
...
var a = cljs.core.into_array.call(null,s);
var n__26040__auto___26879 = a.length;
var i_26880 = (0);
while(true){
if((i_26880 < n__26040__auto___26879)){
var val_26881 = (a[i_26880]);
if((cljs.core.vector_QMARK_.call(null,val_26881)) && ((reagent.impl.template.key_from_vec.call(null,val_26881) == null))){
(o["no-key"] = true);
} else {
}

(a[i_26880] = reagent.impl.template.as_element.call(null,val_26881));

var G__26882 = (i_26880 + (1));
i_26880 = G__26882;
continue;
} else {
}
...
var ctx = ({});
var vec__26886 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__26886,(0),null);
var derefed = cljs.core.nth.call(null,vec__26886,(1),null);
...
var G__26890 = (cljs.core.count.call(null,argv) - first_child);
switch (G__26890) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__26890){
...
//# sourceMappingURL=template.js.map?rel=1488439819970