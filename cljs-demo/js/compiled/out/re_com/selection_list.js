...
var args29526 = [];
var len__26200__auto___29529 = arguments.length;
var i__26201__auto___29530 = (0);
while(true){
if((i__26201__auto___29530 < len__26200__auto___29529)){
args29526.push((arguments[i__26201__auto___29530]));

var G__29531 = (i__26201__auto___29530 + (1));
i__26201__auto___29530 = G__29531;
continue;
} else {
}
break;
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__29536){
...
var args = map__29539__$1;
var disabled_QMARK_ = cljs.core.get.call(null,map__29539__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__29539__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var item_renderer = cljs.core.get.call(null,map__29539__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.call(null,map__29539__$1,new cljs.core.Keyword(null,"model","model",331153215));
var label_fn = cljs.core.get.call(null,map__29539__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.call(null,map__29539__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.call(null,map__29539__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var hide_border_QMARK_ = cljs.core.get.call(null,map__29539__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var choices = cljs.core.get.call(null,map__29539__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.call(null,map__29539__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798));
var multi_select_QMARK_ = cljs.core.get.call(null,map__29539__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.call(null,(cljs.core.truth_(item_renderer)?((function (selected,map__29539,map__29539__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__29533_SHARP_){
return item_renderer.call(null,p1__29533_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__29539,map__29539__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__29539,map__29539__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__29534_SHARP_){
return re_com.selection_list.as_checked.call(null,p1__29534_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__29539,map__29539__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:((function (selected,map__29539,map__29539__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__29535_SHARP_){
return re_com.selection_list.as_radio.call(null,p1__29535_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__29539,map__29539__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
)),choices);
...
var len__26200__auto___29548 = arguments.length;
var i__26201__auto___29549 = (0);
while(true){
if((i__26201__auto___29549 < len__26200__auto___29548)){
args__26207__auto__.push((arguments[i__26201__auto___29549]));

var G__29550 = (i__26201__auto___29549 + (1));
i__26201__auto___29549 = G__29550;
continue;
} else {
}
break;
...
re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__29542){
var map__29543 = p__29542;
var map__29543__$1 = ((((!((map__29543 == null)))?((((map__29543.cljs$lang$protocol_mask$partition0$ & (64))) || (map__29543.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__29543):map__29543);
var args = map__29543__$1;
if(cljs.core.truth_(((!(goog.DEBUG))?true:re_com.validate.validate_args.call(null,re_com.validate.extract_arg_data.call(null,re_com.selection_list.selection_list_args_desc),args,"selection-list")))){
} else {
throw (new Error("Assert failed: (validate-args-macro selection-list-args-desc args \"selection-list\")"));
}

return ((function (map__29543,map__29543__$1,args){
return (function() { 
var G__29551__delegate = function (p__29545){
...
while (G__29552__i < G__29552__a.length) {G__29552__a[G__29552__i] = arguments[G__29552__i + 0]; ++G__29552__i;}
  p__29545 = new cljs.core.IndexedSeq(G__29552__a,0);
} 
return G__29551__delegate.call(this,p__29545);};
G__29551.cljs$lang$maxFixedArity = 0;
G__29551.cljs$lang$applyTo = (function (arglist__29553){
var p__29545 = cljs.core.seq(arglist__29553);
return G__29551__delegate(p__29545);
});
G__29551.cljs$core$IFn$_invoke$arity$variadic = G__29551__delegate;
return G__29551;
})()
;
;})(map__29543,map__29543__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq29541){
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq29541));
});


//# sourceMappingURL=selection_list.js.map?rel=1488439823799