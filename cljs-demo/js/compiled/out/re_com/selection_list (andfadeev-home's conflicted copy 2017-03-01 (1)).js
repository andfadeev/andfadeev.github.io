...
var args116548 = [];
var len__26200__auto___116551 = arguments.length;
var i__26201__auto___116552 = (0);
while(true){
if((i__26201__auto___116552 < len__26200__auto___116551)){
args116548.push((arguments[i__26201__auto___116552]));

var G__116553 = (i__26201__auto___116552 + (1));
i__26201__auto___116552 = G__116553;
continue;
} else {
}
break;
...
var G__116550 = args116548.length;
switch (G__116550) {
case 2:
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args116548.length)].join('')));
...
var base_style__$1 = (cljs.core.truth_((function (){var and__25113__auto__ = selected_QMARK_;
...
var base_style__$2 = (cljs.core.truth_((function (){var and__25113__auto__ = selected_QMARK_;
if(cljs.core.truth_(and__25113__auto__)){
...
if(cljs.core.truth_((function (){var and__25113__auto__ = required_QMARK_;
if(cljs.core.truth_(and__25113__auto__)){
...
], null),new cljs.core.Keyword(null,"child","child",623967545),new cljs.core.PersistentVector(null, 11, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.misc.checkbox,new cljs.core.Keyword(null,"model","model",331153215),cljs.core.some_QMARK_.call(null,selections.call(null,item_id)),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (item_id){
return (function (){
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__116558){
var map__116561 = p__116558;
var map__116561__$1 = ((((!((map__116561 == null)))?((((map__116561.cljs$lang$protocol_mask$partition0$ & (64))) || (map__116561.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__116561):map__116561);
var args = map__116561__$1;
var disabled_QMARK_ = cljs.core.get.call(null,map__116561__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__116561__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var item_renderer = cljs.core.get.call(null,map__116561__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.call(null,map__116561__$1,new cljs.core.Keyword(null,"model","model",331153215));
var label_fn = cljs.core.get.call(null,map__116561__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.call(null,map__116561__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.call(null,map__116561__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var hide_border_QMARK_ = cljs.core.get.call(null,map__116561__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var choices = cljs.core.get.call(null,map__116561__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.call(null,map__116561__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798));
var multi_select_QMARK_ = cljs.core.get.call(null,map__116561__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.call(null,(cljs.core.truth_(item_renderer)?((function (selected,map__116561,map__116561__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__116555_SHARP_){
return item_renderer.call(null,p1__116555_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__116561,map__116561__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__116561,map__116561__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__116556_SHARP_){
return re_com.selection_list.as_checked.call(null,p1__116556_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__116561,map__116561__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:((function (selected,map__116561,map__116561__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__116557_SHARP_){
return re_com.selection_list.as_radio.call(null,p1__116557_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__116561,map__116561__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
)),choices);
...
var len__26200__auto___116570 = arguments.length;
var i__26201__auto___116571 = (0);
while(true){
if((i__26201__auto___116571 < len__26200__auto___116570)){
args__26207__auto__.push((arguments[i__26201__auto___116571]));

var G__116572 = (i__26201__auto___116571 + (1));
i__26201__auto___116571 = G__116572;
continue;
} else {
}
break;
...
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(argseq__26208__auto__);
});

re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__116564){
var map__116565 = p__116564;
var map__116565__$1 = ((((!((map__116565 == null)))?((((map__116565.cljs$lang$protocol_mask$partition0$ & (64))) || (map__116565.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__116565):map__116565);
var args = map__116565__$1;
if(cljs.core.truth_(((!(goog.DEBUG))?true:re_com.validate.validate_args.call(null,re_com.validate.extract_arg_data.call(null,re_com.selection_list.selection_list_args_desc),args,"selection-list")))){
} else {
throw (new Error("Assert failed: (validate-args-macro selection-list-args-desc args \"selection-list\")"));
}

return ((function (map__116565,map__116565__$1,args){
return (function() { 
var G__116573__delegate = function (p__116567){
var map__116568 = p__116567;
var map__116568__$1 = ((((!((map__116568 == null)))?((((map__116568.cljs$lang$protocol_mask$partition0$ & (64))) || (map__116568.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__116568):map__116568);
var args__$1 = map__116568__$1;
...
var G__116573 = function (var_args){
var p__116567 = null;
if (arguments.length > 0) {
var G__116574__i = 0, G__116574__a = new Array(arguments.length -  0);
while (G__116574__i < G__116574__a.length) {G__116574__a[G__116574__i] = arguments[G__116574__i + 0]; ++G__116574__i;}
  p__116567 = new cljs.core.IndexedSeq(G__116574__a,0);
} 
return G__116573__delegate.call(this,p__116567);};
G__116573.cljs$lang$maxFixedArity = 0;
G__116573.cljs$lang$applyTo = (function (arglist__116575){
var p__116567 = cljs.core.seq(arglist__116575);
return G__116573__delegate(p__116567);
});
G__116573.cljs$core$IFn$_invoke$arity$variadic = G__116573__delegate;
return G__116573;
})()
;
;})(map__116565,map__116565__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq116563){
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq116563));
});


//# sourceMappingURL=selection_list.js.map?rel=1488400166958