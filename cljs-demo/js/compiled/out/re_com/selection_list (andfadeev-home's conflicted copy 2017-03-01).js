...
var args96740 = [];
var len__26200__auto___96743 = arguments.length;
var i__26201__auto___96744 = (0);
while(true){
if((i__26201__auto___96744 < len__26200__auto___96743)){
args96740.push((arguments[i__26201__auto___96744]));

var G__96745 = (i__26201__auto___96744 + (1));
i__26201__auto___96744 = G__96745;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args96740.length)].join('')));
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__96750){
var map__96753 = p__96750;
var map__96753__$1 = ((((!((map__96753 == null)))?((((map__96753.cljs$lang$protocol_mask$partition0$ & (64))) || (map__96753.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__96753):map__96753);
var args = map__96753__$1;
var disabled_QMARK_ = cljs.core.get.call(null,map__96753__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__96753__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var item_renderer = cljs.core.get.call(null,map__96753__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.call(null,map__96753__$1,new cljs.core.Keyword(null,"model","model",331153215));
var label_fn = cljs.core.get.call(null,map__96753__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.call(null,map__96753__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.call(null,map__96753__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var hide_border_QMARK_ = cljs.core.get.call(null,map__96753__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var choices = cljs.core.get.call(null,map__96753__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.call(null,map__96753__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798));
var multi_select_QMARK_ = cljs.core.get.call(null,map__96753__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.call(null,(cljs.core.truth_(item_renderer)?((function (selected,map__96753,map__96753__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__96747_SHARP_){
return item_renderer.call(null,p1__96747_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__96753,map__96753__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__96753,map__96753__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__96748_SHARP_){
return re_com.selection_list.as_checked.call(null,p1__96748_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__96753,map__96753__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:((function (selected,map__96753,map__96753__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__96749_SHARP_){
return re_com.selection_list.as_radio.call(null,p1__96749_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__96753,map__96753__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
)),choices);
...
var len__26200__auto___96762 = arguments.length;
var i__26201__auto___96763 = (0);
while(true){
if((i__26201__auto___96763 < len__26200__auto___96762)){
args__26207__auto__.push((arguments[i__26201__auto___96763]));

var G__96764 = (i__26201__auto___96763 + (1));
i__26201__auto___96763 = G__96764;
continue;
} else {
}
break;
...
re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__96756){
var map__96757 = p__96756;
var map__96757__$1 = ((((!((map__96757 == null)))?((((map__96757.cljs$lang$protocol_mask$partition0$ & (64))) || (map__96757.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__96757):map__96757);
var args = map__96757__$1;
if(cljs.core.truth_(((!(goog.DEBUG))?true:re_com.validate.validate_args.call(null,re_com.validate.extract_arg_data.call(null,re_com.selection_list.selection_list_args_desc),args,"selection-list")))){
} else {
throw (new Error("Assert failed: (validate-args-macro selection-list-args-desc args \"selection-list\")"));
}

return ((function (map__96757,map__96757__$1,args){
return (function() { 
var G__96765__delegate = function (p__96759){
var map__96760 = p__96759;
var map__96760__$1 = ((((!((map__96760 == null)))?((((map__96760.cljs$lang$protocol_mask$partition0$ & (64))) || (map__96760.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__96760):map__96760);
var args__$1 = map__96760__$1;
...
var G__96765 = function (var_args){
var p__96759 = null;
if (arguments.length > 0) {
var G__96766__i = 0, G__96766__a = new Array(arguments.length -  0);
while (G__96766__i < G__96766__a.length) {G__96766__a[G__96766__i] = arguments[G__96766__i + 0]; ++G__96766__i;}
  p__96759 = new cljs.core.IndexedSeq(G__96766__a,0);
} 
return G__96765__delegate.call(this,p__96759);};
G__96765.cljs$lang$maxFixedArity = 0;
G__96765.cljs$lang$applyTo = (function (arglist__96767){
var p__96759 = cljs.core.seq(arglist__96767);
return G__96765__delegate(p__96759);
});
G__96765.cljs$core$IFn$_invoke$arity$variadic = G__96765__delegate;
return G__96765;
})()
;
;})(map__96757,map__96757__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq96755){
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq96755));
});


//# sourceMappingURL=selection_list.js.map?rel=1488399761818