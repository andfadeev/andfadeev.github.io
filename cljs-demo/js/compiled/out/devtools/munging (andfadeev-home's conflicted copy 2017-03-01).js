...
try{var o__39140__auto___110029 = t;
goog.object.get(o__39140__auto___110029,"cljs$lang$ctorPrWriter").call(o__39140__auto___110029,t,writer);
}catch (e110028){var __110030 = e110028;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__110032 = num_code;
switch (G__110032) {
case (1):
return (185);
...
}catch (e110038){var e__39165__auto__ = e110038;
return false;
}})())){
...
var vec__110039 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__110039,(0),null);
...
var len__26200__auto___110048 = arguments.length;
var i__26201__auto___110049 = (0);
while(true){
if((i__26201__auto___110049 < len__26200__auto___110048)){
args__26207__auto__.push((arguments[i__26201__auto___110049]));

var G__110050 = (i__26201__auto___110049 + (1));
i__26201__auto___110049 = G__110050;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__110044){
var vec__110045 = p__110044;
var ns_detector = cljs.core.nth.call(null,vec__110045,(0),null);
...
var G__110051 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__110052 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__110051;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq110042){
var G__110043 = cljs.core.first.call(null,seq110042);
var seq110042__$1 = cljs.core.next.call(null,seq110042);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__110043,seq110042__$1);
});
...
var vec__110060 = cljs.core.split_with.call(null,(function (p1__110056_SHARP_){
return cljs.core.not_EQ_.call(null,p1__110056_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__110060,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__110060,(1),null);
...
var vec__110066 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__110066,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__110066,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__110069 = cljs.core.rest.call(null,remaining_tokens);
var G__110070 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__110069;
name_tokens = G__110070;
continue;
} else {
...
var args110071 = [];
var len__26200__auto___110083 = arguments.length;
var i__26201__auto___110084 = (0);
while(true){
if((i__26201__auto___110084 < len__26200__auto___110083)){
args110071.push((arguments[i__26201__auto___110084]));

var G__110085 = (i__26201__auto___110084 + (1));
i__26201__auto___110084 = G__110085;
continue;
} else {
}
break;
...
var G__110073 = args110071.length;
switch (G__110073) {
case 1:
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args110071.length)].join('')));
...
var vec__110074 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__110074,(0),null);
var arity = cljs.core.nth.call(null,vec__110074,(1),null);
var vec__110077 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__110077,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__110077,(1),null);
var vec__110080 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__110080,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__110080,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__110080,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__110080,(3),null);
...
var args110087 = [];
var len__26200__auto___110093 = arguments.length;
var i__26201__auto___110094 = (0);
while(true){
if((i__26201__auto___110094 < len__26200__auto___110093)){
args110087.push((arguments[i__26201__auto___110094]));

var G__110095 = (i__26201__auto___110094 + (1));
i__26201__auto___110094 = G__110095;
continue;
} else {
}
break;
...
var G__110089 = args110087.length;
switch (G__110089) {
case 1:
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args110087.length)].join('')));
...
var vec__110090 = result;
var munged_ns = cljs.core.nth.call(null,vec__110090,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__110090,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__110090,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__110090,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__110090,(4),null);
var arity = cljs.core.nth.call(null,vec__110090,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__110103 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__110103,(0),null);
var args = cljs.core.nth.call(null,vec__110103,(1),null);
var vec__110106 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__110106,(0),null);
var name = cljs.core.nth.call(null,vec__110106,(1),null);
...
var G__110109 = (arity + (1));
var G__110110 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__110111){
var vec__110115 = p__110111;
var arity = cljs.core.nth.call(null,vec__110115,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__110115,(1),null);
...
return (function (p1__110118_SHARP_){
return cljs.core.get.call(null,arities,p1__110118_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__110119_SHARP_){
return cljs.core.drop.call(null,(2),p1__110119_SHARP_);
...
var args__26207__auto__ = [];
var len__26200__auto___110126 = arguments.length;
var i__26201__auto___110127 = (0);
while(true){
if((i__26201__auto___110127 < len__26200__auto___110126)){
args__26207__auto__.push((arguments[i__26201__auto___110127]));

var G__110128 = (i__26201__auto___110127 + (1));
i__26201__auto___110127 = G__110128;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__110122){
var vec__110123 = p__110122;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__110123,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq110120){
var G__110121 = cljs.core.first.call(null,seq110120);
var seq110120__$1 = cljs.core.next.call(null,seq110120);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__110121,seq110120__$1);
});
...
var G__110130 = (((arg instanceof cljs.core.Keyword))?arg.fqn:null);
switch (G__110130) {
...
var map__110137 = options;
var map__110137__$1 = ((((!((map__110137 == null)))?((((map__110137.cljs$lang$protocol_mask$partition0$ & (64))) || (map__110137.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__110137):map__110137);
var include_ns_QMARK_ = cljs.core.get.call(null,map__110137__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__110137__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__110137__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__110137__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__110138 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__110138,(0),null);
var fn_name = cljs.core.nth.call(null,vec__110138,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__110138,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__110138,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__110138,(4),null);
var arity = cljs.core.nth.call(null,vec__110138,(5),null);
...
}catch (e110143){var e__39165__auto__ = e110143;
...
var G__110144 = goog.object.get(obj,cljs.core.first.call(null,path));
var G__110145 = cljs.core.rest.call(null,path);
obj = G__110144;
path = G__110145;
continue;
} else {
...
return (function (accum,p__110150){
var vec__110151 = p__110150;
var bit = cljs.core.nth.call(null,vec__110151,(0),null);
var protocol = cljs.core.nth.call(null,vec__110151,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__110154){
var vec__110158 = p__110154;
var ns = cljs.core.nth.call(null,vec__110158,(0),null);
var name = cljs.core.nth.call(null,vec__110158,(1),null);
var selector = cljs.core.nth.call(null,vec__110158,(2),null);
...
return (function (p__110166){
var vec__110167 = p__110166;
var munged_name = cljs.core.nth.call(null,vec__110167,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__110167,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__110167,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__110161_SHARP_){
return goog.object.get(obj,cljs.core.first.call(null,p1__110161_SHARP_));
});})(name,sorted_matches,vec__110167,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1488399924036