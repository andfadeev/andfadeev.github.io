...
var map__124075 = top_item;
var map__124075__$1 = ((((!((map__124075 == null)))?((((map__124075.cljs$lang$protocol_mask$partition0$ & (64))) || (map__124075.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__124075):map__124075);
var file = cljs.core.get.call(null,map__124075__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__124075__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__124075__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e124074){var _e = e124074;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___124077 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___124077)){
var seen_errors_124078 = temp__4655__auto___124077;
if(cljs.core.truth_(seen_errors_124078.has(self))){
} else {
seen_errors_124078.add(self);

var temp__4657__auto___124079 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___124079)){
var sense_124080 = temp__4657__auto___124079;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_124080)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1488400181403