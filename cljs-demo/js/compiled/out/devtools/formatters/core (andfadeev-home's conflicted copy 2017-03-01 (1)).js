...
var and__25113__auto__ = cljs.core.not.call(null,devtools.formatters.state.prevent_recursion_QMARK_.call(null));
if(and__25113__auto__){
var or__25125__auto__ = devtools.formatters.helpers.cljs_value_QMARK_.call(null,value);
...
}catch (e123765){var e__39165__auto__ = e123765;
return false;
...
}catch (e123767){var e__39165__auto__ = e123767;
return false;
...
}catch (e123773){var e__39165__auto__ = e123773;
return false;
...
}catch (e123775){var e__39165__auto__ = e123775;
return false;
...
}catch (e123781){var e__39165__auto__ = e123781;
return false;
}})())){
...
}catch (e123783){var e__39165__auto__ = e123783;
return false;
}})())){
...
var _STAR_current_state_STAR_123786 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = (function (){var or__25125__auto__ = config;
if(cljs.core.truth_(or__25125__auto__)){
return or__25125__auto__;
} else {
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_123786;
}});
});
...
return (function() { 
var G__123789__delegate = function (args){
try{return cljs.core.apply.call(null,f,args);
}catch (e123788){var e = e123788;
console.error("CLJS DevTools internal error:",e);

return null;
}};
var G__123789 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__123790__i = 0, G__123790__a = new Array(arguments.length -  0);
while (G__123790__i < G__123790__a.length) {G__123790__a[G__123790__i] = arguments[G__123790__i + 0]; ++G__123790__i;}
  args = new cljs.core.IndexedSeq(G__123790__a,0);
} 
return G__123789__delegate.call(this,args);};
G__123789.cljs$lang$maxFixedArity = 0;
G__123789.cljs$lang$applyTo = (function (arglist__123791){
var args = cljs.core.seq(arglist__123791);
return G__123789__delegate(args);
});
G__123789.cljs$core$IFn$_invoke$arity$variadic = G__123789__delegate;
return G__123789;
})()
;
});
...
var pre_handler = (function (){var or__25125__auto__ = devtools.prefs.pref.call(null,pre_handler_key);
if(cljs.core.truth_(or__25125__auto__)){
return or__25125__auto__;
} else {
...
var post_handler = (function (){var or__25125__auto__ = devtools.prefs.pref.call(null,post_handler_key);
if(cljs.core.truth_(or__25125__auto__)){
return or__25125__auto__;
} else {
return cljs.core.identity;
...
//# sourceMappingURL=core.js.map?rel=1488400180855