...
var len__26200__auto___129366 = arguments.length;
var i__26201__auto___129367 = (0);
while(true){
if((i__26201__auto___129367 < len__26200__auto___129366)){
args__26207__auto__.push((arguments[i__26201__auto___129367]));

var G__129368 = (i__26201__auto___129367 + (1));
i__26201__auto___129367 = G__129368;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__26208__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq129364){
var G__129365 = cljs.core.first.call(null,seq129364);
var seq129364__$1 = cljs.core.next.call(null,seq129364);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__129365,seq129364__$1);
});
...
return (function (p1__129369_SHARP_){
return (p1__129369_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1488400202431