...
var len__26200__auto___123364 = arguments.length;
var i__26201__auto___123365 = (0);
while(true){
if((i__26201__auto___123365 < len__26200__auto___123364)){
args__26207__auto__.push((arguments[i__26201__auto___123365]));

var G__123366 = (i__26201__auto___123365 + (1));
i__26201__auto___123365 = G__123366;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__26208__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq123361){
var G__123362 = cljs.core.first.call(null,seq123361);
var seq123361__$1 = cljs.core.next.call(null,seq123361);
var G__123363 = cljs.core.first.call(null,seq123361__$1);
var seq123361__$2 = cljs.core.next.call(null,seq123361__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__123362,G__123363,seq123361__$2);
});
...
if(cljs.core.truth_((function (){var or__25125__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__25731__auto__,writer__25732__auto__,opt__25733__auto__){
return cljs.core._write.call(null,writer__25732__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__25113__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__25113__auto__){
var or__25125__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__25125__auto__)){
return or__25125__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__123367_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__123367_SHARP_));
})))){
...
var map__123376 = opts;
var map__123376__$1 = ((((!((map__123376 == null)))?((((map__123376.cljs$lang$protocol_mask$partition0$ & (64))) || (map__123376.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__123376):map__123376);
var markup_db = cljs.core.get.call(null,map__123376__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__25125__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e123380){var e__39165__auto__ = e123380;
return false;
}})();
if(cljs.core.truth_(or__25125__auto__)){
return or__25125__auto__;
...
}catch (e123382){var e__39165__auto__ = e123382;
return false;
}}
})())){
...
var _STAR_current_state_STAR_123387 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__123388 = opts;
var map__123388__$1 = ((((!((map__123388 == null)))?((((map__123388.cljs$lang$protocol_mask$partition0$ & (64))) || (map__123388.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__123388):map__123388);
var markup_db = cljs.core.get.call(null,map__123388__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_123387;
}});
...
;
var temp__4655__auto___123393 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___123393)){
var managed_print_level_123394 = temp__4655__auto___123393;
var _STAR_print_level_STAR_123392_123395 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_123394;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_123392_123395,managed_print_level_123394,temp__4655__auto___123393,writer,opts,job_fn){
return (function (p1__123390_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__123390_SHARP_,null);
});})(_STAR_print_level_STAR_123392_123395,managed_print_level_123394,temp__4655__auto___123393,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_123392_123395;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1488400179973