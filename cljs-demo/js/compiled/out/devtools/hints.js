...
var file = cljs.core.get.call(null,map__38652__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__38652__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__38652__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e38651){var _e = e38651;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___38654 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___38654)){
var seen_errors_38655 = temp__4655__auto___38654;
if(cljs.core.truth_(seen_errors_38655.has(self))){
} else {
seen_errors_38655.add(self);

var temp__4657__auto___38656 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___38656)){
var sense_38657 = temp__4657__auto___38656;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_38657)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1488439832616