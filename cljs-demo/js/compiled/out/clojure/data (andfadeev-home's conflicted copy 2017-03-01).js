...
return cljs.core.reduce.call(null,(function (result,p__109952){
var vec__109953 = p__109952;
var k = cljs.core.nth.call(null,vec__109953,(0),null);
var v = cljs.core.nth.call(null,vec__109953,(1),null);
...
var vec__109959 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__109959,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__109959,(1),null);
var ab = cljs.core.nth.call(null,vec__109959,(2),null);
...
var args109962 = [];
var len__26200__auto___109965 = arguments.length;
var i__26201__auto___109966 = (0);
while(true){
if((i__26201__auto___109966 < len__26200__auto___109965)){
args109962.push((arguments[i__26201__auto___109966]));

var G__109967 = (i__26201__auto___109966 + (1));
i__26201__auto___109966 = G__109967;
continue;
} else {
}
break;
...
var G__109964 = args109962.length;
switch (G__109964) {
case 2:
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args109962.length)].join('')));
...
var x__25788__auto__ = (((x == null))?null:x);
var m__25789__auto__ = (clojure.data.equality_partition[goog.typeOf(x__25788__auto__)]);
if(!((m__25789__auto__ == null))){
return m__25789__auto__.call(null,x);
} else {
var m__25789__auto____$1 = (clojure.data.equality_partition["_"]);
if(!((m__25789__auto____$1 == null))){
return m__25789__auto____$1.call(null,x);
} else {
...
var x__25788__auto__ = (((a == null))?null:a);
var m__25789__auto__ = (clojure.data.diff_similar[goog.typeOf(x__25788__auto__)]);
if(!((m__25789__auto__ == null))){
return m__25789__auto__.call(null,a,b);
} else {
var m__25789__auto____$1 = (clojure.data.diff_similar["_"]);
if(!((m__25789__auto____$1 == null))){
return m__25789__auto____$1.call(null,a,b);
} else {
...
return (function (){var G__109972 = (((clojure.data.equality_partition.call(null,a) instanceof cljs.core.Keyword))?clojure.data.equality_partition.call(null,a).fqn:null);
switch (G__109972) {
case "atom":
...
//# sourceMappingURL=data.js.map?rel=1488399923533