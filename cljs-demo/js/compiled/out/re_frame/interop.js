...
return [cljs.core.str((function (){var pred__29634 = cljs.core.instance_QMARK_;
var expr__29635 = reactive_val;
if(cljs.core.truth_(pred__29634.call(null,reagent.ratom.RAtom,expr__29635))){
return "ra";
} else {
if(cljs.core.truth_(pred__29634.call(null,reagent.ratom.RCursor,expr__29635))){
return "rc";
} else {
if(cljs.core.truth_(pred__29634.call(null,reagent.ratom.Reaction,expr__29635))){
return "rx";
} else {
if(cljs.core.truth_(pred__29634.call(null,reagent.ratom.Track,expr__29635))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1488439824275