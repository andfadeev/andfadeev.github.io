...
var vec__114492_114495 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_114496 = cljs.core.nth.call(null,vec__114492_114495,(0),null);
var only_after_114497 = cljs.core.nth.call(null,vec__114492_114495,(1),null);
var db_changed_QMARK__114498 = (cljs.core.some_QMARK_.call(null,only_before_114496)) || (cljs.core.some_QMARK_.call(null,only_after_114497));
if(db_changed_QMARK__114498){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_114496);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_114497);
...
var map__114505 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__114505__$1 = ((((!((map__114505 == null)))?((((map__114505.cljs$lang$protocol_mask$partition0$ & (64))) || (map__114505.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__114505):map__114505);
var db = cljs.core.get.call(null,map__114505__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__114505__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__114513 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__114513__$1 = ((((!((map__114513 == null)))?((((map__114513.cljs$lang$protocol_mask$partition0$ & (64))) || (map__114513.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__114513):map__114513);
var coeffects = map__114513__$1;
var event = cljs.core.get.call(null,map__114513__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__26200__auto___114516 = arguments.length;
var i__26201__auto___114517 = (0);
while(true){
if((i__26201__auto___114517 < len__26200__auto___114516)){
args__26207__auto__.push((arguments[i__26201__auto___114517]));

var G__114518 = (i__26201__auto___114517 + (1));
i__26201__auto___114517 = G__114518;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__26208__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq114515){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq114515));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__25125__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__26207__auto__ = [];
var len__26200__auto___114524 = arguments.length;
var i__26201__auto___114525 = (0);
while(true){
if((i__26201__auto___114525 < len__26200__auto___114524)){
args__26207__auto__.push((arguments[i__26201__auto___114525]));

var G__114526 = (i__26201__auto___114525 + (1));
i__26201__auto___114525 = G__114526;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__26208__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__114519_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__114520_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__114520_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq114521){
var G__114522 = cljs.core.first.call(null,seq114521);
var seq114521__$1 = cljs.core.next.call(null,seq114521);
var G__114523 = cljs.core.first.call(null,seq114521__$1);
var seq114521__$2 = cljs.core.next.call(null,seq114521__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__114522,G__114523,seq114521__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1488400161371