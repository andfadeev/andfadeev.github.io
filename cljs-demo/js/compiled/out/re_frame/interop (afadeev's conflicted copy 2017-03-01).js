...
return [cljs.core.str((function (){var pred__104552 = cljs.core.instance_QMARK_;
var expr__104553 = reactive_val;
if(cljs.core.truth_(pred__104552.call(null,reagent.ratom.RAtom,expr__104553))){
return "ra";
} else {
if(cljs.core.truth_(pred__104552.call(null,reagent.ratom.RCursor,expr__104553))){
return "rc";
} else {
if(cljs.core.truth_(pred__104552.call(null,reagent.ratom.Reaction,expr__104553))){
return "rx";
} else {
if(cljs.core.truth_(pred__104552.call(null,reagent.ratom.Track,expr__104553))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1488399835357