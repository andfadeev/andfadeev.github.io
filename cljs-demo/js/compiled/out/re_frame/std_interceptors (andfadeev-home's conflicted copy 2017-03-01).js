...
var vec__91933_91936 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_91937 = cljs.core.nth.call(null,vec__91933_91936,(0),null);
var only_after_91938 = cljs.core.nth.call(null,vec__91933_91936,(1),null);
var db_changed_QMARK__91939 = (cljs.core.some_QMARK_.call(null,only_before_91937)) || (cljs.core.some_QMARK_.call(null,only_after_91938));
if(db_changed_QMARK__91939){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_91937);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_91938);
...
var map__91946 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__91946__$1 = ((((!((map__91946 == null)))?((((map__91946.cljs$lang$protocol_mask$partition0$ & (64))) || (map__91946.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__91946):map__91946);
var db = cljs.core.get.call(null,map__91946__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__91946__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__91954 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__91954__$1 = ((((!((map__91954 == null)))?((((map__91954.cljs$lang$protocol_mask$partition0$ & (64))) || (map__91954.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__91954):map__91954);
var coeffects = map__91954__$1;
var event = cljs.core.get.call(null,map__91954__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__26200__auto___91957 = arguments.length;
var i__26201__auto___91958 = (0);
while(true){
if((i__26201__auto___91958 < len__26200__auto___91957)){
args__26207__auto__.push((arguments[i__26201__auto___91958]));

var G__91959 = (i__26201__auto___91958 + (1));
i__26201__auto___91958 = G__91959;
continue;
} else {
}
break;
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq91956){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq91956));
});
...
var args__26207__auto__ = [];
var len__26200__auto___91965 = arguments.length;
var i__26201__auto___91966 = (0);
while(true){
if((i__26201__auto___91966 < len__26200__auto___91965)){
args__26207__auto__.push((arguments[i__26201__auto___91966]));

var G__91967 = (i__26201__auto___91966 + (1));
i__26201__auto___91966 = G__91967;
continue;
} else {
}
break;
...
return (function (p1__91960_SHARP_){
return cljs.core.get_in.call(null,new_db,p1__91960_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__91961_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__91961_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq91962){
var G__91963 = cljs.core.first.call(null,seq91962);
var seq91962__$1 = cljs.core.next.call(null,seq91962);
var G__91964 = cljs.core.first.call(null,seq91962__$1);
var seq91962__$2 = cljs.core.next.call(null,seq91962__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__91963,G__91964,seq91962__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1488399753622