...
var vec__30112_30115 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_30116 = cljs.core.nth.call(null,vec__30112_30115,(0),null);
var only_after_30117 = cljs.core.nth.call(null,vec__30112_30115,(1),null);
var db_changed_QMARK__30118 = (cljs.core.some_QMARK_.call(null,only_before_30116)) || (cljs.core.some_QMARK_.call(null,only_after_30117));
if(db_changed_QMARK__30118){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_30116);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_30117);
...
var map__30125 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__30125__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__30125__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__30133 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__30133__$1 = ((((!((map__30133 == null)))?((((map__30133.cljs$lang$protocol_mask$partition0$ & (64))) || (map__30133.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__30133):map__30133);
var coeffects = map__30133__$1;
var event = cljs.core.get.call(null,map__30133__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__26200__auto___30136 = arguments.length;
var i__26201__auto___30137 = (0);
while(true){
if((i__26201__auto___30137 < len__26200__auto___30136)){
args__26207__auto__.push((arguments[i__26201__auto___30137]));

var G__30138 = (i__26201__auto___30137 + (1));
i__26201__auto___30137 = G__30138;
continue;
} else {
}
break;
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq30135){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq30135));
});
...
var args__26207__auto__ = [];
var len__26200__auto___30144 = arguments.length;
var i__26201__auto___30145 = (0);
while(true){
if((i__26201__auto___30145 < len__26200__auto___30144)){
args__26207__auto__.push((arguments[i__26201__auto___30145]));

var G__30146 = (i__26201__auto___30145 + (1));
i__26201__auto___30145 = G__30146;
continue;
} else {
}
break;
...
return cljs.core.get_in.call(null,new_db,p1__30139_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__30140_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__30140_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq30141){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__30142,G__30143,seq30141__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1488439824867