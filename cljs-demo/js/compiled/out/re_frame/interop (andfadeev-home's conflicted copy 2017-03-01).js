...
return [cljs.core.str((function (){var pred__88981 = cljs.core.instance_QMARK_;
var expr__88982 = reactive_val;
if(cljs.core.truth_(pred__88981.call(null,reagent.ratom.RAtom,expr__88982))){
return "ra";
} else {
if(cljs.core.truth_(pred__88981.call(null,reagent.ratom.RCursor,expr__88982))){
return "rc";
} else {
if(cljs.core.truth_(pred__88981.call(null,reagent.ratom.Reaction,expr__88982))){
return "rx";
} else {
if(cljs.core.truth_(pred__88981.call(null,reagent.ratom.Track,expr__88982))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1488399650063