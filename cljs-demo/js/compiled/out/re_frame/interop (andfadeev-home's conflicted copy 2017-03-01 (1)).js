...
return [cljs.core.str((function (){var pred__114137 = cljs.core.instance_QMARK_;
var expr__114138 = reactive_val;
if(cljs.core.truth_(pred__114137.call(null,reagent.ratom.RAtom,expr__114138))){
return "ra";
} else {
if(cljs.core.truth_(pred__114137.call(null,reagent.ratom.RCursor,expr__114138))){
return "rc";
} else {
if(cljs.core.truth_(pred__114137.call(null,reagent.ratom.Reaction,expr__114138))){
return "rx";
} else {
if(cljs.core.truth_(pred__114137.call(null,reagent.ratom.Track,expr__114138))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1488400160577